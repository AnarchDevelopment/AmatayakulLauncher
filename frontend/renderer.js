document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            btn_apply_tweaks: "Aplicar Ajustes",
            tweak_shaders_title: "Shaders",
            tweak_shaders_desc: "Aplica shaders de AnarchDevelopment al juego para mejorar los gráficos.",
            tweak_fullbright_title: "Full Bright",
            tweak_fullbright_desc: "Modifica la gama del juego para que todo sea completamente brillante.",
            tweak_autogap_title: "AutoGap",
            tweak_autogap_desc: "Modifica el tiempo de consumo de las manzanas doradas.",
            tweak_autogap_warning: "Esta función se eliminó debido a que los servidores consideran que Amatayakul Client es trampa.",
        ...
        en: {
            ...
            tweak_shaders_title: "Shaders",
            tweak_shaders_desc: "Applies AnarchDevelopment shaders to the game for enhanced visuals.",
            tweak_fullbright_title: "Full Bright",
            tweak_fullbright_desc: "Modifies the game gamma to make everything fully bright.",
            tweak_autogap_title: "AutoGap",
            tweak_autogap_desc: "Modifies the consumption time of golden apples.",
            tweak_autogap_warning: "This function was removed due to servers considering Amatayakul Client as a cheat.",
        ...
        pt: {
            ...
            btn_apply_tweaks: "Aplicar Ajustes",
            tweak_shaders_title: "Shaders",
            tweak_shaders_desc: "Aplica shaders do AnarchDevelopment ao jogo para melhorar os gráficos.",
            tweak_fullbright_title: "Full Bright",
            tweak_fullbright_desc: "Modifica o gama do jogo para tornar tudo completamente brilhante.",
            tweak_autogap_title: "AutoGap",
            tweak_autogap_desc: "Modifica o tempo de consumo das maçãs douradas.",
            tweak_autogap_warning: "Esta função foi removida porque os servidores consideram o Amatayakul Client como trapaça.",
